...
from services.mailbox_jobs import ensure_mailbox_sync_worker, get_mailbox_worker_status, queue_mailbox_sync_job
...
def sync():
    ...
    ensure_mailbox_sync_worker(current_app._get_current_object())
